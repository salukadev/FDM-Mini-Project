...
def register_callbacks(dashapp):
    ...
    #quiz - question
    @dashapp.callback(
        [Output('body-div', 'children'), Output('score', "data"), Output('quizinput', "value"), Output('img_watch',
                                                                                                       'style'), Output('img_watch', 'src'), Output('score_output', 'children'), Output('quizinput', "style")],
    ...
    def update_output(n_clicks, value, score,):
        ...
        if n_clicks == 3:
            ...
            if value == str(current_time.year):
                return "What day of the week is it today?    Ex: Sunday", score + 1, '', {'display': 'none'}, '', '', {'display': 'block'}
            else:
                return "What day of the week is it today?    Ex: Sunday", score + 0, '', {'display': 'none'}, '', '', {'display': 'block'}
